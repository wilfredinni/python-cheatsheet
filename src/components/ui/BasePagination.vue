...
<template>
  <div class="mt-5 grid grid-cols-1 gap-4 pt-5 text-slate-400 sm:grid-cols-2">
    <router-link
      v-if="previous"
      :to="previous.path"
      class="grid w-full rounded-lg border p-5 transition duration-300 hover:border-sky-500 hover:bg-sky-400/5 dark:border-slate-800 dark:hover:border-sky-50"
    >
